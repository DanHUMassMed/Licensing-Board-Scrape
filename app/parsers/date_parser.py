...
class DateParser:
    ...
    def _parse_from_body(self, text, matches):
        ...
        if match:
            ...
            matches['month'] = matches['month'] or (f"{self.MONTH_NAME_TO_NUM[month_name.capitalize()]:02d}" if month_name else None)
    ...
    def _parse_from_href_month(self, text, matches):
        ...
        if match:
            month_name, day, year = match.groups()
            matches['month'] = matches['month'] or f"{self.MONTH_NAME_TO_NUM[month_name.capitalize()]:02d}"
